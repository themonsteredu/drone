  ...
  plans: [
    {
      id: "medical-safe",
      label: "안전 우회 항로",
      summary: "고도 5~9m로 상승해 높은 암반과 강풍 구역 바깥을 우회한 뒤 하강합니다.",
      badge: "교육 추천",
      distanceLabel: "비행거리 약 42m",
    ...
    },
    {
      id: "medical-fast",
      label: "신속 직선 항로",
      summary: "고도 6~9m로 암반 사이를 통과합니다. 강풍을 보정한 뒤 착륙장으로 하강하세요.",
      badge: "빠른 대응",
      distanceLabel: "비행거리 약 34m",
  ...
  plans: [
    {
      id: "search-sweep",
      label: "안전 순환 수색",
      summary: "잔해 옆으로 넓게 우회하고 신호 지점에서 하강합니다. 복귀 때는 고도 11.5m를 확보하세요.",
      badge: "교육 추천",
      distanceLabel: "수색거리 약 88m",
      durationLabel: "예상 3분",
      energyLabel: "배터리 보통",
      riskLabel: "시야 확보 우수",
      waypoints: [
    ...
    },
    {
      id: "search-direct",
      label: "상공 횡단 수색",
      summary: "고도 10.5~11.5m로 잔해 위를 넘고, 각 신호 지점에서 하강해 확인합니다.",
      badge: "숙련 운항",
      distanceLabel: "수색거리 약 95m",
      durationLabel: "예상 3분",
      energyLabel: "상승 시 소모 주의",
      riskLabel: "높은 잔해 · 하강 주의",
      waypoints: [
        { x: 0, y: 2, z: 0 },
        { x: -5, y: 5, z: 4 },
        { x: -5, y: 1.2, z: 8 },
